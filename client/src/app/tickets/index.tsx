...
export function Tickets() {
  ...
  return (
    <div className="w-full flex flex-col gap-6 mb-10 relative p-4 lg:px-7">
      <div className="w-full rounded-2xl p-4 bg-[#FAFAFA] sticky top-3 z-10 flex gap-6 flex-col md:flex-row items-center">
